    ...
    <form @submit.prevent="createEvent">
      ...
      <template v-if="$v.event.category.$error">
        <p
          ...
          class="errorMessage">Category is required
        </p>
      </template>
      ...
      <template v-if="$v.event.description.$error">
        <p
          ...
          class="errorMessage">Description is required
        </p>
      </template>
      ...
      <template v-if="$v.event.location.$error">
        <p
          ...
          class="errorMessage">Location is required
        </p>
      </template>
      ...
      <template v-if="$v.event.date.$error">
        <p
          ...
          class="errorMessage">Date is required
        </p>
      </template>
      ...
      <template v-if="$v.event.time.$error">
        <p
          ...
          class="errorMessage">Time is required
        </p>
      </template>
